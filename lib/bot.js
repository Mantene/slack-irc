...
import { highlightUsername, commandHelp, ircTopic, onlineIRCUsers, setIRCTopic } from './helpers';
...
class Bot {
  constructor(options) {
    ...
    const authpost = new WebClient('xoxp-212187614244-213194150678-212657886898-71e054506ef26d086c2d7103e979ba3a');
...
//    this.slack.rtm.on(RTM_EVENTS.CHANNEL_RENAME, function handleChannelRename(newName) {
//      logger.debug(`Channel Renamed: ${newName}`)
//    })
  ...
  processCommandMessage(message) {
    ...
    const setNewTopic = setIRCTopic.bind(this);
    ...
    if (match.length > 1) {
      ...
      switch (command) {
        ...
        case 'help':
          ...
          break;
        case 'topic':
          setNewTopic(message, argument, remaining);
          break;
        case 'msg':
          if (remaining) {
